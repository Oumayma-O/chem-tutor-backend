"""
Categorised few-shot calibration examples for the LLM equivalence grader.
...
compact; _GENERAL is always appended as a fallback anchor.

Format inside each block:
  STUDENT:   "<raw student text>"
  CANONICAL: "<expected answer>"
  VERDICT:   CORRECT  – reason note
             WRONG    – feedback: "<max-20-word hint>"
"""
...
def select_examples(correct_answer: str, step_label: str) -> str:
    ...
    Always includes _GENERAL.  Prepends at most two domain-specific blocks
